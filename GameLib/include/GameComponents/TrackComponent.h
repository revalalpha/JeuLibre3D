...
struct TrackComponent
{
	...
	float step = 0.001f;					   ///< Sampling step size along the curve (smaller = more points, smoother but more expensive).
	float trackWidth = 8.0f;               ///< Width of the track, used for rendering and collision.
};