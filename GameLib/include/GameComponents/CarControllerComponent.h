...
struct CarControllerComponent
{
	...
	float maxSpeed = 40.0f;       ///< The maximum speed the car can reach
	float speed = 0.0f;           ///< The current speed of the car, updated by the physics system
	float liveAccel = 0.0f;       ///< Current acceleration factor, computed from delta speed
	float smoothLiveAccel = 0.0f; ///< Current acceleration factor, computed from delta speed
